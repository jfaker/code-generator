...
<link type="text/css" rel="stylesheet" href="${domainConfig.resource}/resource/rainbow/github.css"/>
<script type="text/javascript" src="${domainConfig.resource}/resource/rainbow/rainbow-custom.min.js"></script>
