...
function SimpleDrag(source, target)
{
    this.x = 0;
    this.y = 0;
    ...
    this.start = function(event){
        ...
        this.frame.style.zIndex = SimpleDrag.zIndex + 1;
        this.target.style.zIndex = (SimpleDrag.zIndex++);
...
SimpleDrag.zIndex = 1001;

SimpleDrag.register = function(source, target){
    var e = document.getElementById(source);

    if(e != null)
    {
        new SimpleDrag(e, document.getElementById(target));
    }
};

SimpleDrag.dragable = function(source, target, event)
{
    var e = source;
    ...
    if(e != null)
    {
        if(e.getAttribute("dragable") != "1")
        {
            ...
            if(e.style.zIndex != SimpleDrag.zIndex)
            {
                SimpleDrag.zIndex = SimpleDrag.zIndex + 2;
                e.style.zIndex = SimpleDrag.zIndex;
            }

            new SimpleDrag(e, target);
        }
    }
};
